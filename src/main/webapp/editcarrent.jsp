			...
			<div class="form-group row">
				...
				<div class="col-6">
				     <select class="form-control" id="status" name="status">
						<option <%if(resultSet.getBoolean("CARRENTSTATUS") == true){ %> <%="selected"%> <%}%> value="TRUE">Available</option>
  						<option <%if(resultSet.getBoolean("CARRENTSTATUS") == false){ %> <%="selected"%> <%}%> value="FALSE">Not Available</option>		
					</select>	
				</div>
			</div>
			<div class="form-group row">
